...
object SystemStarter extends App {
  ...
  val ClientActor5 = system.actorOf(Props(new Client(SystemActor, "tanja", 56, "567890", Query("apartment", "25-12-2021", category = Some(5)))), "Client5") // could be the same as Client3, if Client3 fails, they will find an alternative booking
}
